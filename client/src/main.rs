    ...
    T: PacketTx + PacketRx + Display + Clone + 'static,
{
    ...
    /// This method adds a get() RPC header to a request.
    #[inline]
    ...
    fn generate_request(&self) {
        ...
        unsafe {
            ...
            // Once the request has been sent out, the packet needs to be
            // freed and returned to Netbricks. To safely do so, reconstruct
            // a packet from the underlying mbuf, and have Netbricks free it.
